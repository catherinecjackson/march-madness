...
n_runs = 10_000_000
global results = DataFrame("Bracket" => fill(DataFrame(), n_runs), "TotalLikelihood" => fill(0, n_runs))
...
for i = 1:n_runs
    ...
    if df[idx3, :ExitRound] > "4"
        totallikelihood = totallikelihood + 1.75
    end
    ...
    idx10 = findfirst(df.Teams .== winner63)
    if df[idx10, :Seeds] > 5
